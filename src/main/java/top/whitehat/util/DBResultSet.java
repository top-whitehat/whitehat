...
public class DBResultSet implements ResultSet {
	...
	/** save a ResultSet to CSV file */
	public int toCSV(String csvFilePath) throws IOException, SQLException {
		try (FileWriter writer = new FileWriter(csvFilePath)) {
			return print(writer);
		}
	}

	/** get string of current record */
	public String getRecordString() {
		return getRecordString(-1);
	}

	protected String encodeCSV(String value) {
		// quote if needed
		if (value != null) {
	...
	/** get CSV string of current record */
	protected String getRecordString(int columnCount) {
	...
	/** print to writer */
	public int print(Writer writer) throws IOException, SQLException {
		ResultSetMetaData metaData = rs.getMetaData();
		int columnCount = metaData.getColumnCount();
		...
		int rowCount = 0;
		while (rs.next()) {
			writer.write(getRecordString(columnCount));
			writer.write("\n");
			rowCount++;
		}
	...
	public String toString() {
		...
		try {
			...
			writer = new OutputStreamWriter(buffer, StandardCharsets.UTF_8); // TODO charset
			print(writer);
